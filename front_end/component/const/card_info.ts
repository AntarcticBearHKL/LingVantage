export const card_info_context = {
    main_color: 'rgb(183,198,175)',
...
export const card_info_enchanter = {
    main_color: 'rgb(181,180,162)',
...
export const card_info_mirror = {
    main_color: 'rgb(167,184,208)',
